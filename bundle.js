...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/jovanilic25', responseHandler1)
...
function portfolioComponent ({ data = {}, theme = {} } = {}) {
  ...
  function openNewTab() {
    var url = "https://jovanilic25.github.io/quiz/"
...
function footerComponent ({ data = {}, theme = {} } = {}) {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/jovanilic25">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="mailto:jovanilic25@gmail.com ">
